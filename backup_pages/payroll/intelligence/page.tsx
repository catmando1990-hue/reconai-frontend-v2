...
import { usePayrollIntelligence } from "@/hooks/usePayrollIntelligence";
import {
  getSeverityBgClass,
  formatConfidence,
...
/**
 * Payroll Intelligence Page
 *
 * Domain-specific intelligence for Payroll module:
          ...
          <div className="bg-muted/50 border border-border rounded-lg p-3">
            <div className="flex items-start gap-2">
              ...
              <p className="text-xs text-muted-foreground">
                This is an AI-generated advisory signal for payroll oversight.
                Payroll Intelligence signals relate to variance anomalies,
                overtime, tax withholding, and compensation outliers. Consult
                with HR and payroll administrators before making changes.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-foreground">
              Payroll Intelligence is Advisory Only
            </p>
            <p className="text-sm text-muted-foreground mt-1">
              Signals are generated by AI analysis of your payroll data.
              Categories include: variance anomalies, overtime spikes, tax
              withholding risks, and employee pay outliers. These insights
        ...
        <Card className="border-border bg-card">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-sm text-muted-foreground max-w-md mx-auto mb-4">
              {showLowConfidence
                ? "No payroll signals found. Process more pay runs to generate intelligence."
                : "No high-confidence signals found. Enable 'Show low confidence signals' or process more payroll data."}
            </p>
