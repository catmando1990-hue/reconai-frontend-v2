    ...
    <div className="core-intelligence">
      ...
      <header className="ci-header">
        <div className="ci-header-left">
          ...
          <p className="ci-header-subtitle">AI-powered bookkeeping and accounting insights</p>
        </div>
      ...
      <div className="ci-disclaimer-footer">
        ...
        <div>
          ...
          <p>
            Core Intelligence provides AI-generated advisory insights into your bookkeeping data.
            These signals support accounting accuracy but do not replace professional accounting advice.
          </p>
        </div>
      </div>
    </div>
