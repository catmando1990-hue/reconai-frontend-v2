...
export default function DashboardPage() {
  ...
  const [expandedAssetCategory, setExpandedAssetCategory] = useState<string | null>(null);
  const [expandedLiabilityCategory, setExpandedLiabilityCategory] = useState<string | null>(null);
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-8">
          <div className="mb-2 flex items-center gap-3">
            <p className="text-primary font-mono text-xs tracking-[0.2em] uppercase">Dashboard</p>
            <PageHelp
              title="Dashboard"
          ...
          {statCards.map((stat, _index) => {
            ...
            return (
              <motion.div
                ...
                onClick={isNetWorth ? () => setShowNetWorthModal(true) : undefined}
              ...
              >
                ...
                <Link href="/invoices" className="group">
                  <div className="hover:border-primary/20 rounded-xl border border-white/5 bg-card/70 p-5 backdrop-blur-sm transition-all duration-300">
                    ...
                    <div className="flex items-center justify-between">
                      <p className="text-muted-foreground text-sm tracking-wider uppercase">Receivables</p>
                ...
                <Link href="/bills" className="group">
                  <div className="hover:border-primary/20 rounded-xl border border-white/5 bg-card/70 p-5 backdrop-blur-sm transition-all duration-300">
                    ...
                    <div className="flex items-center justify-between">
                      <p className="text-muted-foreground text-sm tracking-wider uppercase">Payables</p>
                      <ChevronRight className="text-muted-foreground group-hover:text-primary h-4 w-4 transition-colors" />
                    </div>
                    <div className="mt-3 flex gap-2 text-xs">
                ...
                <Link href="/customers" className="group">
                  <div className="hover:border-primary/20 rounded-xl border border-white/5 bg-card/70 p-5 backdrop-blur-sm transition-all duration-300">
                    ...
                    <div className="flex items-center justify-between">
                      <p className="text-muted-foreground text-sm tracking-wider uppercase">Customers</p>
                      <ChevronRight className="text-muted-foreground group-hover:text-primary h-4 w-4 transition-colors" />
                    </div>
                    <p className="text-muted-foreground mt-3 text-xs">
                      {formatCurrency(metrics.summary.totalInvoicePaid)} collected
                    </p>
                  </div>
                </Link>
                ...
                <Link href="/vendors" className="group">
                  <div className="hover:border-primary/20 rounded-xl border border-white/5 bg-card/70 p-5 backdrop-blur-sm transition-all duration-300">
                    ...
                    <div className="flex items-center justify-between">
                      <p className="text-muted-foreground text-sm tracking-wider uppercase">Vendors</p>
                      <ChevronRight className="text-muted-foreground group-hover:text-primary h-4 w-4 transition-colors" />
                    </div>
                    <p className="text-muted-foreground mt-3 text-xs">
        ...
        <div className="mb-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          >
            <div className="mb-6">
              ...
              <h2 className="text-foreground text-lg">Spending by Category</h2>
            </div>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div
                        className={`flex h-10 w-10 items-center justify-center rounded-lg ${
                          tx.type === 'income' ? 'bg-primary/10' : 'bg-card/10'
                        }`}
                      >
                        <Icon
                          className={`h-5 w-5 ${
                      ...
                      <div>
                        <p className="text-foreground font-medium">{tx.merchant}</p>
                    ...
                    <p
                      className={`font-mono font-semibold ${
                        tx.amount > 0 ? 'text-reconai-success' : 'text-foreground'
                      }`}
                    >
                      {tx.amount > 0 ? '+' : ''}$
            ...
            >
              ...
              <div className="flex items-center justify-between border-b border-white/5 p-6">
                <div>
                  ...
                  <h2 className="text-foreground text-2xl font-light">Net Worth</h2>
                </div>
                <button
                  onClick={() => setShowNetWorthModal(false)}
              ...
              <div className="max-h-[calc(85vh-180px)] overflow-y-auto p-6">
                ...
                <div className="mb-6 rounded-xl border border-white/5 bg-card/60 p-6">
                  <div className="grid grid-cols-3 gap-4 text-center">
                    ...
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-muted-foreground font-mono text-xs tracking-wider uppercase">Minus</p>
                    </div>
                    <div>
                      <p className="text-muted-foreground mb-2 font-mono text-xs tracking-wider uppercase">
                        Total Liabilities
                ...
                <div className="mb-6">
                  <div className="mb-4 flex items-center gap-2">
                    ...
                    <h3 className="text-foreground text-lg font-medium">Assets</h3>
                      ...
                      >
                        <button
                          onClick={() =>
                            setExpandedAssetCategory(
                              expandedAssetCategory === category ? null : category
                            )
                          }
                        ...
                        >
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <motion.div
                              animate={{ rotate: expandedAssetCategory === category ? 180 : 0 }}
                                  ...
                                  return (
                                    ...
                                    >
                                      <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                          <p className="text-foreground text-sm">{asset.name}</p>
                                          {asset.description && (
                                            <p className="text-muted-foreground text-xs">
                                              {asset.description}
                                            </p>
                ...
                <div>
                  <div className="mb-4 flex items-center gap-2">
                    ...
                    <h3 className="text-foreground text-lg font-medium">Liabilities</h3>
                        ...
                        <button
                          onClick={() =>
                            setExpandedLiabilityCategory(
                              expandedLiabilityCategory === category ? null : category
                            )
                          }
                          className="flex w-full items-center justify-between px-4 py-3 transition-colors hover:bg-card/10"
                        >
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <motion.div
                              animate={{ rotate: expandedLiabilityCategory === category ? 180 : 0 }}
                              transition={{ duration: 0.2 }}
                            >
                              <ChevronDown className="text-muted-foreground h-4 w-4" />
                            </motion.div>
                                  ...
                                  return (
                                    ...
                                    >
                                      <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                          <p className="text-foreground text-sm">{liability.name}</p>
                                          <div className="flex items-center gap-2">
              ...
              <div className="flex items-center justify-between border-b border-white/5 p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <h2 className="text-foreground text-xl font-medium">{selectedInsight.title}</h2>
                  </div>
                </div>
                <button
                  onClick={() => setSelectedInsight(null)}
              ...
              <div className="max-h-[calc(85vh-180px)] overflow-y-auto p-6">
                ...
                {selectedInsight.detailedInfo.stats && (
                  <div className="mb-6 grid grid-cols-2 gap-3 md:grid-cols-4">
                    {selectedInsight.detailedInfo.stats.map((stat, idx) => (
                      <div key={idx} className="rounded-xl border border-white/5 bg-card/60 p-4">
                        <p className="text-muted-foreground mb-1 text-xs tracking-wider uppercase">
                          {stat.label}
                        </p>
                        <p className="text-foreground font-mono text-lg font-semibold">{stat.value}</p>
                ...
                {selectedInsight.detailedInfo.progress !== undefined && (
                  <div className="mb-6">
                    ...
                    <div className="h-3 overflow-hidden rounded-full bg-card/60">
                      <motion.div
                        initial={{ width: 0 }}
                        animate={{ width: `${selectedInsight.detailedInfo.progress}%` }}
                    ...
                    {selectedInsight.detailedInfo.currentAmount &&
                      selectedInsight.detailedInfo.targetAmount && (
                        <div className="text-muted-foreground mt-2 flex justify-between text-xs">
                          <span>
                            ${selectedInsight.detailedInfo.currentAmount.toLocaleString()} saved
                          </span>
                          <span>
                            ${selectedInsight.detailedInfo.targetAmount.toLocaleString()} goal
                          </span>
                        </div>
                      )}
                  </div>
                ...
                {selectedInsight.detailedInfo.breakdown && (
                  <div className="mb-6">
                    ...
                    <div className="space-y-2">
                      {selectedInsight.detailedInfo.breakdown.map((item, idx) => {
                        const ItemIcon = item.icon || Receipt;
                        const total = selectedInsight.detailedInfo.breakdown!.reduce(
                          (sum, i) => sum + i.amount,
                          0
                        );
                          ...
                          >
                            ...
                            <div className="flex-1">
                              <div className="mb-1 flex items-center justify-between">
                                ...
                                <span className="text-primary font-mono text-sm">${item.amount}</span>
                              </div>
                ...
                {selectedInsight.detailedInfo.timeline && (
                  <div className="mb-6">
                    ...
                    <div className="space-y-0">
                      {selectedInsight.detailedInfo.timeline.map((event, idx) => (
                        <div key={idx} className="flex items-start gap-3">
                          <div className="flex flex-col items-center">
                            <div
                              className={`flex h-6 w-6 items-center justify-center rounded-full ${
                                event.completed ? 'bg-reconai-success/20' : 'bg-card/60'
                              }`}
                            >
                              {event.completed ? (
                            ...
                            {idx < selectedInsight.detailedInfo.timeline!.length - 1 && (
                              <div
                ...
                {selectedInsight.detailedInfo.recommendations && (
                  <div className="mb-6">
                    ...
                    <ul className="space-y-2">
                      {selectedInsight.detailedInfo.recommendations.map((rec, idx) => (
                        <li key={idx} className="flex items-start gap-3 rounded-lg bg-card/60 p-3">
