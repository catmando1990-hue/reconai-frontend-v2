...
/**
 * About page — inherits header/background from MarketingLayout.
    ...
    <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
            ...
            <div>
              ...
              <p className="mt-4 text-muted-foreground">
                I built ReconAI because making decisions without visibility into
                your own financial data is unacceptable. Existing tools fail
                under real scrutiny. They fragment information across systems,
                automate without explanation, and produce outputs that cannot be
              ...
              <p className="mt-4 text-muted-foreground">
                ...
                data. Every automated suggestion requires manual approval. Every
                report can be audited. The system does not make decisions on
                your behalf. It surfaces the information you need to make them
                yourself.
              </p>
              <p className="mt-4 text-muted-foreground">
      ...
      <section className="mt-20">
        ...
        <div className="mt-8 space-y-8">
          ...
          <div className="rounded-xl border border-border bg-card/70 p-6 backdrop-blur">
            ...
            <p className="mt-3 text-muted-foreground">
              Clarity is not about more data. It is about less noise. The system
              transforms raw transaction feeds into defensible positions. When a
              question arises about spend, compliance, or allocation, the answer
          ...
          <div className="rounded-xl border border-border bg-card/70 p-6 backdrop-blur">
            ...
            <p className="mt-3 text-muted-foreground">
              ...
              classification includes confidence scores and source links. Every
              automated action is logged and reversible. Disclaimers are
            ...
            <p className="mt-3 text-muted-foreground">
              ...
              When trust conflicts with speed, trust wins. This is a deliberate
              choice, even when it slows adoption.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-border bg-card/70 p-6 backdrop-blur">
            ...
            <p className="mt-3 text-muted-foreground">
              ...
              design. Automated suggestions surface recommendations but require
              explicit human approval before any data is modified. Kill switches
              exist at every layer. Role-based access controls enforce
              separation of duties. Phased rollouts prevent system-wide
              failures.
            </p>
            <p className="mt-3 text-muted-foreground">
              AI capabilities operate human-in-the-loop. The system does not
              remove responsibility from the user. It restores it. You see what
              the system sees. You approve what the system does. You own the
              outcome.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 rounded-xl border border-primary/30 bg-card/50 p-6 backdrop-blur">
          <p className="text-center text-muted-foreground italic">
            ReconAI gives founders clarity they can trust, and control they can
            defend.
          </p>
        </div>
      </section>
      ...
      <section className="mt-20">
        ...
        <p className="mt-4 text-muted-foreground">
          ...
          connects to your accounts, categorizes transactions, detects patterns,
          and generates reports that link back to source data. Every output is
          traceable.
        </p>
        <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-xl border border-border bg-card/70 p-5 backdrop-blur">
            ...
            <div className="mt-1 text-sm text-muted-foreground">
              Surfaces anomalies, duplicates, and cost structures automatically.
            </div>
          </div>
          <div className="rounded-xl border border-border bg-card/70 p-5 backdrop-blur">
      ...
      <section className="mt-20">
        ...
        <p className="mt-4 text-muted-foreground">
          ...
          enterprise teams requiring compliance documentation and audit trails.
        </p>
        ...
        <div className="mt-8 space-y-4">
          <div className="flex items-start gap-4 rounded-xl border border-border bg-card/70 p-5 backdrop-blur">
            ...
            <div>
              ...
              <div className="mt-1 text-sm text-muted-foreground">
                Core transaction management, classification accuracy, and export
                reliability.
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 rounded-xl border border-border bg-card/70 p-5 backdrop-blur">
            ...
            <div>
              ...
              <div className="mt-1 text-sm text-muted-foreground">
                Advanced compliance modules, custom integrations, and dedicated
                support tiers.
              </div>
            </div>
          </div>
