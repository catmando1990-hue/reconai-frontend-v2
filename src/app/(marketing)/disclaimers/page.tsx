...
/**
 * Disclaimers page — inherits header/background from MarketingLayout.
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="mt-10 space-y-8 text-foreground/90">
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3">Compliance Disclaimer</h2>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            All outputs should be reviewed by qualified personnel before use in
            financial reporting, tax filings, or regulatory submissions.
          </p>
        </section>
