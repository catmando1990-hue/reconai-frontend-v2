...
/**
 * Support page — inherits header/background from MarketingLayout.
    ...
    <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <section className="text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
          Documentation, ticketing, and direct support channels. Response times
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3 text-sm">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Organization Name</strong> — Your company or account
                    name
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-primary" />
                  <span>
                    <strong>Page / Feature</strong> — Which page or feature you
                    were using
                  </span>
                </li>
                <li className="flex items-start gap-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    (e.g.,{" "}
                    <code className="text-xs bg-card/60 px-1.5 py-0.5 rounded">
                      req_abc123...
                    </code>
                    )
                  </span>
      ...
      <section className="mt-20">
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-3">
          <div className="rounded-xl border border-border bg-card/70 p-6 backdrop-blur">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Submit detailed requests with attachments. Best for non-urgent
              issues and documentation requests.
            </p>
            <a
              href="mailto:admin@reconaitechnology.com"
          ...
          <div className="rounded-xl border border-border bg-card/70 p-6 backdrop-blur">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Access help directly from your dashboard. Context-aware assistance
          ...
          <div className="rounded-xl border border-border bg-card/70 p-6 backdrop-blur">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Response times vary by tier and issue severity. Critical issues
      ...
      <section className="mt-20">
        ...
        <p className="mt-4 text-muted-foreground">
          Response time targets are goals, not guarantees. Actual response times
          may vary based on volume and complexity.
        </p>
      ...
      {/* System Status */}
      <section className="mt-20">
        <h2 className="text-2xl font-bold tracking-tight">Incident & Status</h2>
        <p className="mt-4 text-muted-foreground">
        ...
        <div className="mt-8 rounded-xl border border-border bg-card/70 p-6 backdrop-blur">
          ...
          <div className="mt-6 border-t border-border pt-4">
            <div className="text-sm text-muted-foreground">
              ...
              System Status panel. For critical outages, affected users receive
              email notifications.
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Request ID</strong> — Shown in error messages. Looks
                    like: <code className="text-xs">req_abc123...</code>
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="font-mono text-xs bg-card/60 px-2 py-0.5 rounded">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Screenshots</strong> — If applicable, with sensitive
                    data redacted
                  </span>
                </li>
              </ul>
