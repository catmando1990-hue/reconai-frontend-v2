          ...
          <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
            ...
            <div>
              ...
              <p className="mt-4 text-muted-foreground">
                ReconAI exists because financial clarity should not require
                specialized expertise or expensive consultants. Too many
                businesses operate without visibility into their own financial
                data—not because they lack the information, but because the
                tools to organize and interpret it are fragmented, manual, or
                opaque.
              </p>
              <p className="mt-4 text-muted-foreground">
                I built ReconAI as financial infrastructure: a system-of-record
                that structures transactions, surfaces patterns, and produces
                outputs you can trust. Every classification links to source
                data. Every report is traceable. Every automated suggestion
                requires manual approval before it changes anything.
              </p>
              <p className="mt-4 text-muted-foreground">
                The principles are simple: trust through evidence, manual-first
                control, and explainability at every layer. No black boxes. No
                silent background operations. If the system reaches a
                conclusion, you can see exactly how it got there.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="mt-20">
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <div className="rounded-xl border border-border bg-card/70 p-6 backdrop-blur">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Classification confidence scores, pattern detection reasoning, and
              audit logs explain how the system reached its conclusions.
            </p>
          </div>
          <div className="rounded-xl border border-border bg-card/70 p-6 backdrop-blur">
