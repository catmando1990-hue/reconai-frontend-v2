        ...
        <div className="max-w-md w-full">
          <div className="rounded-2xl border bg-card p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              The GovCon module provides DCAA-compliant government contracting tools
              including contract management, timekeeping, indirect cost pools,
            ...
            <div className="p-4 rounded-lg bg-muted/50 mb-6">
              <p className="text-sm text-muted-foreground">
                This module requires <span className="font-medium text-foreground">GovCon</span>,{" "}
                <span className="font-medium text-foreground">Contractor</span>, or{" "}
                <span className="font-medium text-foreground">Enterprise</span> tier.
              </p>
            </div>
