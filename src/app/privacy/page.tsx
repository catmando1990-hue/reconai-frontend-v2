        ...
        <div className="mt-10 space-y-8 text-foreground/90">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ReconAI collects information you provide directly, including
              account details, financial data you upload for reconciliation, and
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              data. Contact us to exercise these rights or for any
