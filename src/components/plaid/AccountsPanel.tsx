...
export function AccountsPanel() {
  ...
  const handleRemoveClick = useCallback(
    (itemId: string, institutionName: string) => {
      setConfirmRemoveItem({ itemId, institutionName });
    },
    []
  );
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <strong>{confirmRemoveItem?.institutionName}</strong>? This will
              disconnect all accounts from this bank. This action cannot be
              undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
