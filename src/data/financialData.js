...
export const transactionData = {
  ...
  income: {
    ...
    freelance: [
      ...
      },
      {
        ...
        date: "2024-06-10",
        source: "Tech Startup Inc",
        description: "Consulting Invoice #1089",
        amount: 4200.0,
      },
      {
        id: "inc_013",
      ...
      },
      {
        ...
        date: "2024-10-05",
        source: "Tech Startup Inc",
        description: "Consulting Invoice #1156",
        amount: 3800.0,
      },
      {
        id: "inc_015",
    ...
    dividends: [
      {
        id: "inc_030",
        date: "2024-03-15",
        source: "Bank of America Investments",
  ...
  deductions: {
    charitable: [
      ...
      },
      {
        id: "ded_005",
        date: "2024-11-25",
        recipient: "Goodwill Industries",
        amount: 800.0,
        cashOrProperty: "property",
      },
      {
        id: "ded_006",
        date: "2024-12-20",
    ...
    mortgage: {
      ...
      totalInterest: 12450.0,
      totalPropertyTax: 4800.0,
      totalPMI: 1200.0,
    },
    studentLoans: {
      servicer: "Navient",
      totalInterest: 1850.0,
    },
  },
  ...
  business: {
    ...
    officeSupplies: [
      { id: "bus_010", date: "2024-01-05", vendor: "Staples", amount: 125.0 },
      { id: "bus_011", date: "2024-03-12", vendor: "Amazon", amount: 89.5 },
      {
        id: "bus_012",
        date: "2024-05-22",
        vendor: "Office Depot",
      ...
      { id: "bus_014", date: "2024-10-15", vendor: "Amazon", amount: 134.0 },
    ],
    software: [
      {
        id: "bus_020",
    ...
    travel: [
      ...
      },
      {
        ...
        description: "Conference - Chicago",
        amount: 312.0,
      },
      {
        id: "bus_033",
      ...
      },
      {
        ...
        date: "2024-10-10",
        vendor: "Southwest",
        description: "Client Visit - Denver",
        amount: 289.0,
      },
    ],
    meals: [
    ...
    homeOffice: {
      ...
      annualRent: 0, // owned
      annualMortgageInterest: 8500.0,
      annualUtilities: 3600.0,
      annualInsurance: 1800.0,
      annualRepairs: 450.0,
    },
    mileage: [
      {
  ...
  estimatedPayments: [
    { id: "est_001", date: "2024-04-15", amount: 3500.0, quarter: "Q1" },
    { id: "est_002", date: "2024-06-15", amount: 3500.0, quarter: "Q2" },
    { id: "est_003", date: "2024-09-15", amount: 3500.0, quarter: "Q3" },
    { id: "est_004", date: "2024-01-15", amount: 3500.0, quarter: "Q4" },
  ],
};
...
export function calculateTaxSummary(year = "2024") {
  ...
  const freelanceTotal = data.income.freelance.reduce(
    (sum, t) => sum + t.amount,
    0,
  );
  const interestTotal = data.income.interest.reduce(
    (sum, t) => sum + t.amount,
    0,
  );
  const dividendsTotal = data.income.dividends.reduce(
    (sum, t) => sum + t.amount,
    0,
  );

  // Deduction totals
  const charitableTotal = data.deductions.charitable.reduce(
    (sum, t) => sum + t.amount,
    0,
  );
  const medicalTotal = data.deductions.medical.reduce(
    (sum, t) => sum + t.amount,
    0,
  );
  ...
  const advertisingTotal = data.business.advertising.reduce(
    (sum, t) => sum + t.amount,
    0,
  );
  const suppliesTotal = data.business.officeSupplies.reduce(
    (sum, t) => sum + t.amount,
    0,
  );
  const softwareTotal = data.business.software.reduce(
    (sum, t) => sum + t.amount,
    0,
  );
  const travelTotal = data.business.travel.reduce(
    (sum, t) => sum + t.amount,
    0,
  );
  const mealsTotal =
    data.business.meals.reduce((sum, t) => sum + t.amount, 0) * 0.5; // 50% deductible
  const mileageTotal =
    data.business.mileage.reduce((sum, t) => sum + t.miles, 0) * 0.67; // 2024 rate

  // Home office calculation
  const homeOffice = data.business.homeOffice;
  const homeOfficePercent =
    homeOffice.officeSquareFeet / homeOffice.totalSquareFeet;
  ...
  // Estimated payments
  const estimatedPaymentsTotal = data.estimatedPayments.reduce(
    (sum, p) => sum + p.amount,
    0,
  );
  ...
  return {
    ...
    deductions: {
      ...
      studentLoanInterest,
      totalItemized:
        charitableTotal + medicalTotal + mortgageInterest + studentLoanInterest,
    },
    business: {
...
export function getTotalBalances() {
  ...
  const liabilities = accounts
    .filter((a) => a.current < 0)
    .reduce((sum, a) => sum + Math.abs(a.current), 0);
