  ...
  return {
    ...
    items: [
      ...
      },
      {
        ...
        summary: "A transaction marked compliance-sensitive is missing supporting context. Add documentation to reduce audit risk.",
        kind: "compliance",
        status: "in_review",
        confidence: 0.78,
        created_at: now,
      },
      {
        ...
        summary: "A new vendor is trending upward over the last 14 days. Validate vendor legitimacy and categorize consistently.",
        kind: "vendor_risk",
        status: "new",
        confidence: 0.66,
        created_at: now,
  ...
  return {
    ...
    items: [
      ...
      },
      {
        ...
        summary: "Suggest a classification rule based on recent merchant behavior and user history.",
        status: "running",
        confidence: 0.74,
        created_at: now,
      },
      {
        ...
        summary: "Draft a short supporting note for a compliance-sensitive transaction for user approval.",
        status: "blocked",
        confidence: 0.61,
        created_at: now,
      },
