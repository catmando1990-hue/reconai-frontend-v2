 ...
 */
export function PanelErrorFallback({ error, resetErrorBoundary }: { error: Error; resetErrorBoundary?: () => void }) {
  return (
    <div className="rounded-2xl border border-red-200 bg-red-50 p-4">
      <div className="text-sm font-medium text-red-800">Failed to load panel</div>
...
export const LazyBenchmarksPanel = React.lazy(
  () => import('../components/platform/BenchmarksPanel').then((m) => ({ default: m.BenchmarksPanel }))
);
...
export const LazyFunnelAttributionPanel = React.lazy(
  () => import('../components/platform/FunnelAttributionPanel').then((m) => ({ default: m.FunnelAttributionPanel }))
);
...
export const LazyOrgGovernancePanel = React.lazy(
  () => import('../components/platform/OrgGovernancePanel').then((m) => ({ default: m.OrgGovernancePanel }))
);
...
export const LazyInvestorAuditPanel = React.lazy(
  () => import('../components/platform/InvestorAuditPanel').then((m) => ({ default: m.InvestorAuditPanel }))
);
...
export const LazyBillingReconcilePanel = React.lazy(
  () => import('../components/billing/BillingReconcilePanel').then((m) => ({ default: m.BillingReconcilePanel }))
);
...
export const LazyKillSwitchStatusPanel = React.lazy(
  () => import('../components/platform/KillSwitchStatusPanel').then((m) => ({ default: m.KillSwitchStatusPanel }))
);
